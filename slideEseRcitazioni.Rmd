...
Hands on: \color{red} Apri o crea un file `.xlsx` sul tuo PC, salvalo in formato **`.csv`** (comma separated values) e importalo su R; poi prova ad importare direttamente il file **`.xlsx`**; in entrambi i casi, osserva la classe e la struttura dell'oggetto importato.
...
Frequenze cumulate, cumulate empiriche
